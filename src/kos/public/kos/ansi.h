...
#define ANSI_CURSOR_UPN(n)           "\x1b[" _CPP_NASH_STR(n) "A"
#define ANSI_CURSOR_DOWN             "\x1b[1B"
#define ANSI_CURSOR_DOWNN(n)         "\x1b[" _CPP_NASH_STR(n) "B"
#define ANSI_CURSOR_RIGHT            "\x1b[1C"
#define ANSI_CURSOR_RIGHTN(n)        "\x1b[" _CPP_NASH_STR(n) "C"
#define ANSI_CURSOR_LEFT             "\x1b[1D"
#define ANSI_CURSOR_LEFTN(n)         "\x1b[" _CPP_NASH_STR(n) "D"
